...
export const cities = {
	...
	'ایلام': { lat: 33.6374, lon: 46.4227 },
	'خرم‌آباد': { lat: 33.4878, lon: 48.3558 },
	'شهرکرد': { lat: 32.3256, lon: 50.8644 },
	'یاسوج': { lat: 30.6684, lon: 51.5870 },
	'بجنورد': { lat: 37.4747, lon: 57.3290 },
	'بیرجند': { lat: 32.8649, lon: 59.2262 },
	'بوشهر': { lat: 28.9260, lon: 50.8850 },
	'سمنان': { lat: 35.5729, lon: 53.3975 },
	'اراک': { lat: 34.0954, lon: 49.6892 }
};
...
// Map province names to representative cities available in the selector
export const provinceToCity = {
	'تهران': 'تهران',
	'خراسان رضوی': 'مشهد',
	'اصفهان': 'اصفهان',
	'فارس': 'شیراز',
